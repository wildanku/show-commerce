...
export default function ContactPage({ contact }: Props) {
  return (
    <Layout title="Contact Us">
      <Head>
        <title>Contact Us - Spices IDN</title>
        <meta
          name="description"
          content="Get in touch with Spices IDN. We're here to help with all your Indonesian spice needs."
        />
      </Head>
      ...
      {/* CTA Section */}
      <section className="bg-linear-to-r from-orange-600 to-orange-700 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Ready to Work With Us?
          </h2>
          <p className="text-lg text-orange-100 mb-8">
            Let's discuss how we can help supply your premium Indonesian product
            needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 bg-green-600 text-white px-8 py-4 rounded-lg font-bold hover:bg-green-700 transition-colors shadow-lg"
            >
              <svg
                className="w-6 h-6"
                fill="none"
